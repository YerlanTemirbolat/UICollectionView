...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        colors = [[
            ...
            Color(color: UIColor(red: 255/255, green: 149/255, blue: 255/255, alpha: 1), hex: "#ff9500"),
            Color(color: UIColor(red: 255/255, green: 191/255, blue: 255/255, alpha: 1), hex: "#ffbf00"),
...
extension ViewController: UICollectionViewDataSource {
    ...
    // TODO 4b: specify number of item in section (required)
